...
class TabCoT(PromptTechnique):
    ...
    def generate_prompt(self, input_text: str, **kwargs) -> str:
        ...
        """
        table_headers = kwargs.get("table_headers", ["Aspect", "Analysis", "Conclusion"])
        analysis_dimensions = kwargs.get("analysis_dimensions", ["Key Facts", "Assumptions", "Implications", "Solution"])
...
class Contrastive(PromptTechnique):
    ...
    def generate_prompt(self, input_text: str, **kwargs) -> str:
        ...
        contrast_dimensions = kwargs.get("contrast_dimensions", ["approach", "assumptions", "outcomes"])
...
class UncertaintyRouted(PromptTechnique):
    ...
    def generate_prompt(self, input_text: str, **kwargs) -> str:
        ...
        }.get(routing_strategy, "Dynamically adjust reasoning depth based on uncertainty")
