...
class StylePrompting(PromptTechnique):
    ...
    def generate_prompt(self, input_text: str, style: str = "professional", **kwargs) -> str:
        """
...
class SimToM(PromptTechnique):
    ...
    def generate_prompt(self, input_text: str, **kwargs) -> str:
        ...
        """
        perspectives = kwargs.get("perspectives", ["different stakeholders", "various viewpoints"])
        context = kwargs.get("context", "")
        ...
        }.get(depth, "deeply consider the mental states, motivations, and perspectives of others")
...
class RaR(PromptTechnique):
    ...
    def generate_prompt(self, input_text: str, **kwargs) -> str:
        ...
        clarify_str = "\n- Address any ambiguities or unclear aspects" if clarify_ambiguity else ""
