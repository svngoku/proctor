...
class SelfCalibration(PromptTechnique):
    ...
    def generate_prompt(self, input_text: str, **kwargs) -> str:
        ...
        """
        calibration_factors = kwargs.get("calibration_factors", ["complexity", "familiarity", "evidence_quality", "reasoning_depth"])
        confidence_scale = kwargs.get("confidence_scale", "0-100")
        
        factors_text = "\n".join([f"- {factor.title()}: [Assess {factor} level]" for factor in calibration_factors])
...
class SelfRefine(PromptTechnique):
    ...
    def generate_prompt(self, input_text: str, **kwargs) -> str:
        ...
        refinement_criteria = kwargs.get("refinement_criteria", ["accuracy", "completeness", "clarity", "efficiency"])
...
class SelfVerification(PromptTechnique):
    ...
    def generate_prompt(self, input_text: str, **kwargs) -> str:
        ...
        """
        verification_methods = kwargs.get("verification_methods", ["logical_check", "consistency_check", "boundary_check", "sanity_check"])
...
class CumulativeReasoning(PromptTechnique):
    ...
    def generate_prompt(self, input_text: str, **kwargs) -> str:
        ...
        validation_checkpoints = kwargs.get("validation_checkpoints", [2, 4, cumulative_steps])
