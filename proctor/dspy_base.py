...
class DSPyPromptTechnique(dspy.Module, ABC):
    """
    ...
    def execute(
        ...
        **kwargs,
        ...
        try:
            ...
            # Take the first output field
            if hasattr(result, '__dict__'):
                fields = {k: v for k, v in result.__dict__.items() if not k.startswith('_')}
                if fields:
                    # Join all output fields
