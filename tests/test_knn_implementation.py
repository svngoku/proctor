...
class TestSemanticKNN(unittest.TestCase):
    ...
    def test_find_nearest(self, mock_cos_sim, mock_transformer):
        ...
        mock_cos_sim.return_value = np.array([[0.8, 0.6]])  # candidate1 is closer than candidate2
        ...
        self.assertEqual(results[0][0], candidates[0])  # candidate1 has higher similarity
