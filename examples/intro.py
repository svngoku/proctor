...
if not openrouter_key:
    print("❌ OPENROUTER_API_KEY not set. Please set it in your .env file to test different models.")
    exit(1)
...
response = claude_technique.execute(
    problem,
...
response = reasoning_technique.execute(
    problem,
